    ...
    <section className="md:w-5/6 lg:w-2/3 mb-8 md:mb-32 flex flex-col md:grid md:grid-cols-3 gap-8 p-6 md:p-0">
      <div className="flex flex-col gap-2 md:text-lg col-span-2 text-neutral-600">
        <p>
          Hi, <br></br>
          My name is{" "}
          <span className={`font-bold text-neutral-800`}>Raymond Mak</span> and
          I'm a
        </p>
        <p
        ...
        <p>
          ...
          frameworks like
          <span className="font-semibold text-neutral-800"> React</span> as well
          as <span className="font-semibold text-neutral-800">TypeScript</span>.{" "}
        </p>
        <p>
